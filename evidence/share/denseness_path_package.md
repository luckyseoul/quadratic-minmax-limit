...
2. **Residual (ii), exact current remainder.** Proposition 15.236/237 covers even \(k\in[3p+1,4p-2]\), and affine two-level is dead for all \(k\ge3p\) (15.179). At **\(k\ge4p\)**, Propositions 15.734--15.737 close the first three shells, and Proposition 15.751 closes \(k=4p+6\) for every \(p\ge13\). Propositions 15.744--15.749 close \(u=0,3,4\) at \(p=13,k=60\). The exact open remainder is: critical \(p=5,7\); \(p=11,k\ge50\); \(p=13,k=60,u=6\) and later \(p=13\) layers; every \(p\ge17,t\ge4\) layer, beginning with \(p=17,k\ge76\); and the separate positive \(p=7,z=7\) branch.
