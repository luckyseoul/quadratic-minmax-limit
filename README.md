...
- **Non-Walsh endpoint at `p=17`.** Propositions 15.700--15.708 reduce the exact
  ledger from 1,575 to 507 profiles, all of pair slack at least 28. Proposition 15.706 excludes both former
...
graph TD
    ...
    FIRSTHALF --> SECONDFINITE["next all-finite even s<br/><b>CLOSED for p>=43 and p=41,37,31,29,19</b>;<br/>p=23 reduced to 133 profiles;<br/>p=17 reduced to 507 profiles, all slack>=28;<br/>p=17,23 OPEN (15.679--15.708)"]
