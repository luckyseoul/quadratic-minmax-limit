...
### Exact Paley-lattice structure (props 15.629–15.639)
...
shell, and the complete first possible nonminimal odd shell. The second
shell cancels the first in every channel, and the complete third shell is
another negative channel. These are a
