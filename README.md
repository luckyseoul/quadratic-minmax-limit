...
are positive, so the shell is a quartic saddle rather than a 4-design. The
principal R1 inequality remains open, and the current floor wiring requires
the separate global-QVAR estimate:
...
### Exact Paley-lattice structure (props 15.629–15.640)
