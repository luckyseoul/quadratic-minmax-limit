...
graph TD
    ...
    FIRSTHALF --> SECONDFINITE["next all-finite even s<br/><b>CLOSED for p>=43 and p=41,37,31,29</b>;<br/>p=23 reduced to 202 profiles; p=17,19,23 OPEN (15.679--15.685)"]
