...
| Residual (ii), even \(k\ge4p\) | **OPEN** | multi-level Max− leftover (15.274); p=5 \(k=20\) leftover+splus empty all nF (15.521/524/528) |
| Type I, multi-level Max− | **OPEN** | 15.275; 15.523; 15.529 \(\Delta_{\mathrm{conn}}\); 15.534 \(I=G\chi S\); 15.536 \(I_\Omega=p S(r/(1+r))\); `type_I_multilevel_bad_case_ND_closed=False` |
