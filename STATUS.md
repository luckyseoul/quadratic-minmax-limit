...
| Type I, multi-level Max− | **OPEN** | 15.275; 15.529 \(\Delta_{\mathrm{conn}}\); 15.536 \(I_\Omega=p S\); 15.538 \(A_{1d,\mathrm{dbl}}=-4p^3/(p-2)\); `type_I_multilevel_bad_case_ND_closed=False` |
