...
| Type I, multi-level Max− | **OPEN** | 15.540 \(A_{1d}(r)\); 15.543 \(\mu_{1d}=\kappa/(p(p-2))\); Aut_e \(G>T\) open; `type_I_multilevel_bad_case_ND_closed=False` |
