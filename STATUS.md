...
| Type I, multi-level Max− | **OPEN** | 15.275; 15.536 \(I_\Omega=p S\); 15.538 \(A_{1d,\mathrm{dbl}}\); 15.540 \(A_{1d}(r)\) all \(r\), \(A_{\mathrm{free}}\) not a \(p\)-law; `type_I_multilevel_bad_case_ND_closed=False` |
