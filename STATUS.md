...
| \(\lambda_{\min}(\Phi)\ge6\) | **OPEN** | 15.279; 15.550–15.557: \(S=\mathrm{Kl}\), Term0, \(G_{3,1d}\) named, \(\sum\Phi_{\mathrm{free}}\) named; pointwise \(\Phi_{\mathrm{free}}\) unnamed; `phi_F_ge_6=False` |
