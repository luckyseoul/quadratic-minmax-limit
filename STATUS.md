...
| \(\lambda_{\min}(\Phi)\ge6\) | **OPEN** | 15.279; 15.550–15.561: \(S=\mathrm{Kl}\), \(J_{\mathrm{all}}/J_T\) named, \(Q_{3,\mathrm{generic}}\) named; \(Q_{3,\mathrm{dbl}}\) / \(Q_{3,n3}\) still live; `phi_F_ge_6=False` |
