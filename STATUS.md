...
| \(\lambda_{\min}(\Phi)\ge6\) | **OPEN** | 15.279; 15.550–15.562: \(S=\mathrm{Kl}\), \(J_{\mathrm{all}}/J_T\) named, \(Q_{3,\mathrm{generic}}\) named, \(A_{k=3}\) named; \(A_{\mathrm{full}}\) for \(m>3\) still live; `phi_F_ge_6=False` |
