...
| Type I, multi-level Max− | **OPEN** | 15.275; 15.523 \(\kappa\)-contraction; 15.529 \(\Delta_{\mathrm{conn}}\); 15.534 \(I=G\chi(\theta)S(-\eta/\theta)\); `type_I_multilevel_bad_case_ND_closed=False` |
