...
| Type I, multi-level Max− | **OPEN** | 15.543 \(\mu_{1d}\); 15.544 p=5 mix \(G>T\); Aut_e \(p>5\) / \(A_{\mathrm{full}}\) open; `type_I_multilevel_bad_case_ND_closed=False` |
