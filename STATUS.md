...
| Type I, multi-level Max− | **OPEN** | 15.275; 15.523 \(\kappa\)-contraction; 15.529 \(\Delta_{\mathrm{conn}}=2G/((p^2-1)p^6)\sum AI\); `type_I_multilevel_bad_case_ND_closed=False` |
