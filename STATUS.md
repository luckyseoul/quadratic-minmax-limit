...
| \(\lambda_{\min}(\Phi)\ge6\) | **OPEN** | 15.279; 15.550–15.558: \(S=\mathrm{Kl}\), Term0, \(J_{\mathrm{all}}/J_T\) named, \(\Phi_{\mathrm{free}}\) still carries live \(Q_{3,T}\); `phi_F_ge_6=False` |
