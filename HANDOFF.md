...
> **Now (2026-08-18):** HEAD 15.561. **Three leftovers remain.** Floor: 15.561 \(n_{k=3}=C(m,3)(p-1)q\) and \(Q_{3,\mathrm{generic}}=(N-n_{k=3})A_{1d}\). \(Q_{3,\mathrm{dbl}}\) / \(Q_{3,n3}\) still carry \(A_{\mathrm{full,dbl}}\) (0 vs \(-4p^3/15\)). Do not interpolate \((p-5)/15\). \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
