...
> **Now (2026-08-18):** HEAD 15.556. **Three leftovers remain.** Floor: 15.556 names the Type+ 1D summand of \(\Phi\): \(G_{3,1d}=[n_{\mathrm{spec}}/p-3(m-n_{\mathrm{spec}})/(p(p-2))]C(p,m)\). \(\Phi=G_{3,1d}+\Phi_{\mathrm{free}}\), \(\Phi_{\mathrm{free}}\) unnamed. 15.555 Norm reduction. \(16pA\) / \(Q_\tau\) still open. 15.549 \(K_\lambda=K_{\mathrm{all}}-Nq(3q-5)\). Residual (ii): 15.552 leftover+splus empty nF=9,11–13 at p=5 \(k=22\) (nF=10 TLE). Type I: 15.551 Galois line-union. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
