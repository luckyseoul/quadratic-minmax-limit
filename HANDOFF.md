...
> **Now (2026-08-18):** HEAD 15.521. **Three leftovers remain.** Residual (ii): leftover+s₊=2 at p=5 \(k=20\) is empty for nF=0..6 (15.521: nF=4,5,6 HiGHS Infeasible; leftover-only at those nF exists with min₊<2). nF≥7 and even \(k>4p\) with far stay open. Do not import the 3600s JSON that forced \(S\equiv2\) on Max+. Floor: p=11 leftover-\(2p\) Fejer is \(904/45\) (15.520). \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
