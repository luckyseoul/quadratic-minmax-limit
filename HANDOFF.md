...
> **Now (2026-08-18):** HEAD 15.560 + unpushed 15.558/15.559. **Three leftovers remain.** Floor: 15.558 \(J_{\mathrm{all}}/J_T\) named complete sums; \(\Phi_{\mathrm{free}}\) still carries live \(Q_{3,T}\). \(Q_{3,02}=-4N(2p^2+1)/p\) from \(F=-2(3p^2+2)\) certified \(p=5..23\). 15.559 Aut_e DEAD as a name of \(A_{\mathrm{full}}\). 15.560 leftover+splus empty nF=0 at p=5 \(k=26,28,30\). \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
