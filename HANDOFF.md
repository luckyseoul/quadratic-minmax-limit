...
- **Residual to \(m_n\ge\Phi-2\Rightarrow L=\tfrac12\):** (1) prove \(g_{\min}\ge-(p-2)/(2p^2)\) or \(a\ge1/(2p-1)\) for **all** primes \(p\ge5\); (2) deep non-tight gap-2 ND / non-undercut. **F13** intact.
