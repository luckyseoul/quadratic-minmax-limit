...
> **Now (2026-08-18):** HEAD 15.547. **Three leftovers remain.** Residual (ii): leftover+splus at p=5 \(k=22\) (even \(>4p\)) is empty for nF=0,3–8,14 (15.547; official \(S\ge2\); leftover-only official nF=3 exists). nF=9..13 and other even \(k>4p\) stay open. Floor: 15.545 names the NL mass \(M_{\mathrm{NL}}=16pA-n_{1d}Q_{1d}^{++}\) at p=5,7. Type I: 15.546 p=7 mix \(109/2863<|T|\). \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
