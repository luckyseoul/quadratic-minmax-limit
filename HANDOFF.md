...
> **Now (2026-08-18):** HEAD 15.557. **Three leftovers remain.** Floor: 15.557 \(\sum\Phi_{\mathrm{free}}=2N(1/p-p)+(p-1)(p+1)^2 C(p,m)/p\). Pointwise \(\Phi_{\mathrm{free}}\) still unnamed. 15.556 \(G_{3,1d}\) named. \(16pA\) / \(Q_\tau\) still open. 15.549 \(K_\lambda=K_{\mathrm{all}}-Nq(3q-5)\). Residual (ii): 15.552 leftover+splus empty nF=9,11–13 at p=5 \(k=22\) (nF=10 TLE). Type I: 15.551 Galois line-union. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
