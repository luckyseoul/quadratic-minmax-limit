...
> **Now (2026-08-18):** HEAD 15.512. **Three leftovers remain.** Frobenius ω-class named (\(|class|=2q\), \(\mathrm{Fix}=2\) at p=5,7). \(D\) and \(Q_\tau\) still unnamed. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
