...
> **Now (2026-08-18):** HEAD 15.549. **Three leftovers remain.** Floor: 15.549 writes \(K_\lambda=K_\lambda^{\mathrm{all}}-Nq(3q-5)\) (complete Paley 4-linear minus Gauss collisions). \(K_\lambda^{\mathrm{all}}\) is not a p-law, so \(16pA\) / \(Q_\tau\) stay open. 15.548 \(I_3\) split and \(G=(N/p)\chi\). Residual (ii): 15.547. Type I: 15.546. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
