...
**Date:** 2026-08-28 (15.682 additionally closes the `p=31,s=26` next all-finite endpoint; no general flag flipped)
...
Thus `p=31,s=26` is impossible. The same boundary remains open at
`p=17,19,23,41`; `p=41` has only residue zero. Later all-finite sizes,
...
Thus `p=29,s=24` is impossible. Proposition 15.682 subsequently closes
`p=31`. The same boundary remains open at `p=17,19,23,41`; `p=41` has only
residue zero. Later all-finite sizes, strict infinity-plus-`p`, residual
...
Thus `p=37,s=30` is impossible. Propositions 15.681--15.682 subsequently
close `p=29,31`; the same boundary at `p=17,19,23,41`, later all-finite
...
Propositions 15.680--15.682 separately close `p=37,29,31`; the smaller
endpoints `17,19,23,41`, later all-finite sizes, strict infinity-plus-`p`,
residual (ii), R1, QVAR, Type I, and the limit remain open.
...
closes `p=29`, and 15.682 closes `p=31`; four smaller endpoints, subsequent
