...
> **Now (2026-08-17 evening):** Leftover 1 still **OPEN**. 15.453–15.478 shipped. 15.478: \(n_{++}=(p^2+2p-15-a_E^2)/8\); linear-χ / quartic type-indicator Fourier miss live \(Q_{++}\) (\(87/13\neq48/13\)). \(Q_\tau\) unnamed. p=11 6-net — leave PID 712954. Do **not** import \(\phi_F\). Residual (ii) \(k\ge4p\) and Type I multi-level still OPEN. Aut-Schur **false**. Live `e1` is the old AND. \(L=\tfrac12\) is **not settled**.  
