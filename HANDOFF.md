...
> **Now (2026-08-18):** HEAD 15.515. **Three leftovers remain.** \(S_2\) is a named quadratic in \(M\); p=5 \(26-7Q_{++}\) sums to \(n_{1d}-k\) but NL summands are negative. \(Q_\tau\) unnamed. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
