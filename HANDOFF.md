...
> **Now (2026-08-18):** HEAD 15.555. **Three leftovers remain.** Floor: 15.555 \(G_3(0,u,v)=\Phi(N(u),N(v),N(v-u))\); \(Q_3=-2Np+q\sum\Phi\,e_\theta(u)e_\varphi(v)\). Φ unnamed (7 / 14 values). 15.554 line-type constants. 15.553 Term0. \(16pA\) / \(Q_\tau\) still open. 15.549 \(K_\lambda=K_{\mathrm{all}}-Nq(3q-5)\). Residual (ii): 15.552 leftover+splus empty nF=9,11–13 at p=5 \(k=22\) (nF=10 TLE). Type I: 15.551 Galois line-union. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
