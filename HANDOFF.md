...
> **Now (2026-08-17 evening):** Leftover 1 still **OPEN**. 15.453–15.471 shipped. Lag-\(s\) \(\Lambda_0,\Lambda_2\) named from 15.468; \(\Lambda_1\neq\mathrm{Cov}_{++}\). p=11 6-net ETA \(\ge580\) h — leave PID 712954. Do **not** import \(\phi_F\). Residual (ii) \(k\ge4p\) and Type I multi-level still OPEN. Aut-Schur **false**. Live `e1` is the old AND. \(L=\tfrac12\) is **not settled**.  
