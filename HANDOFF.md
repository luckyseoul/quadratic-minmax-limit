...
> **Now (2026-08-18):** HEAD 15.514. **Three leftovers remain.** Even pairing \(S_2\) is named in \(M\), not in \(p\); CS/box miss \(Q_{++}\le26/7\). \(D\) and \(Q_\tau\) still unnamed. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
