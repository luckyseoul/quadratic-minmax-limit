...
> **Now (2026-08-17 evening):** Leftover 1 still **OPEN**. 15.453–15.485 shipped. Aut_∞ orbits at p=7 are the AG types (4×stab-2 = 3 NF1 + 1 TR). Multiplicities unnamed in \(p\). \(Q_\tau\) unnamed. p=11 6-net — leave PID 712954. Do **not** import \(\phi_F\). Residual (ii) \(k\ge4p\) and Type I multi-level still OPEN. Aut-Schur **false**. Live `e1` is the old AND. \(L=\tfrac12\) is **not settled**.  
