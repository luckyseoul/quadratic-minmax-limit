...
> **Now (2026-08-18):** HEAD 15.516. **Three leftovers remain.** Ensemble \(L\) on the ns_mix slot equals \(\mu_+\mu_-\); other slots still have den \(D\). \(Q_\tau\) unnamed. \(\phi_F\) not imported. \(L=\tfrac12\) is **not settled**.  
